import "package:divergent_alliance/ui/da_button.dart";
import 'package:flutter/material.dart';

/// WEATHER CENTER (PRO) Ã†â€™Ã¢â€šÂ¬Ã…Â¡Ã‚Â¬Ã¢â‚¬Å¡Ã‚Â¬Ã‚Â simple, readable, drill-down demo
/// Ã†â€™Ã¢â€šÂ¬Ã…Â¡Ã‚Â¬Ã¢â‚¬Å¡ Shows Region summary, KPI chips, and State Ã†â€™Ã¢â‚¬Å¡Ã‚Â¬Ã‚Â Ã¢â‚¬Å¡Ã‚Â¬Ã¢â‚¬Å¾ County drill-down
/// Ã†â€™Ã¢â€šÂ¬Ã…Â¡Ã‚Â¬Ã¢â‚¬Å¡ Uses local demo data so you can see layout immediately
/// Ã†â€™Ã¢â€šÂ¬Ã…Â¡Ã‚Â¬Ã¢â‚¬Å¡ Keep the class name exactly as-is (WeatherCenterPro) Ã†â€™Ã¢â€šÂ¬Ã…Â¡Ã‚Â¬Ã¢â‚¬Å¡Ã‚Â¬Ã‚Â main.dart depends on it
...
class _WeatherCenterProState extends State<WeatherCenterPro> {
  ...
  String? _state;
  int _Wind ≥ mph35; // Clamp between 20..120 if you add networking later
  ...
  Widget _filters() {
    return Wrap(
      ...
      children: [
        ...
        _fieldCard(
          title: 'Wind Ã¢â€°Â¥ mph Ã†â€™Ã¢â‚¬Å¡Ã‚Â¬Ã‚Â°Ã¢â‚¬Å¡',
          child: TextField(
            controller: TextEditingController(text: '$_Wind ≥ mphkeyboardType: TextInputType.number,
            onSubmitted: (v) => setState(() {
              final n = int.tryParse(v) ?? _Wind ≥ mph_Wind ≥ mphn.clamp(20, 120);
            }),
          ),
        ),
        _fieldCard(
  ...
  Widget _summaryHeader(_Totals t) {
    return Wrap(
      spacing: 8,
      runSpacing: 8,
      children: [
        ...
        _pill('Wind Ã¢â€°Â¥ Wind Ã¢â€°Â¥ Mph mph'),
        _pill('Days', '$_daysOut'),
  ...
  Widget _countyTile(Map<String, dynamic> r) {
    final county = (r['county'] ?? 'Ã†â€™Ã¢â€šÂ¬Ã…Â¡Ã‚Â¬Ã¢â‚¬Å¡Ã‚Â¬Ã‚Â').toString();
  ...
  Widget _pill(String label, [String? value]) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(blurRadius: 0.5, spreadRadius: 0.5, color: Colors.black54)
        ],
      ),
      child: Row(
  ...
  Widget _badge(String text) {
    final t = text.isEmpty ? 'Ã†â€™Ã¢â€šÂ¬Ã…Â¡Ã‚Â¬Ã¢â‚¬Å¡Ã‚Â¬Ã‚Â' : text;
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
      decoration: BoxDecoration(
  ...
  Map<String, List<Map<String, dynamic>>> _groupByState(
